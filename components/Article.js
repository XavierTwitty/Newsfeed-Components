...
function articleMaker(article) {
  ...
  const extraButton = document.createElement("span");
  ...
  extraButton.classList.add("expandButton");
  div.appendChild(extraButton);

  // articleTitle.textContent = article;
  // date.textContent = article;
  // extraButton.textContent = article;
...
const newArtilce = articleMaker("hello".title);
